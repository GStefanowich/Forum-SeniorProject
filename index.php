...
<?php
	...
	echo "<p>&emsp; The forum is coded in PHP/HTML, and would not naturally run on any computer without additional software. This PHP server is brought to you by the operating system <i>Raspbian</i>, which is a modified version of the linux operating system <i>Debian</i>, created for the <i>Raspberry Pi</i>. The <i>Raspberry Pi</i> is a microcomputer which only consists of: a motherboard, 512MB of RAM, a processor, and various attached ports. An 8GB memory card, and a wireless adapter had to be added to it.</p>";
